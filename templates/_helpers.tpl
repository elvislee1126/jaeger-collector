...
helm.sh/chart: {{ include "jaeger-collector.chart" . }}
...
app.kubernetes.io/name: {{ include "jaeger-collector.name" . }}
...
{{- default (include "jaeger-collector.fullname" .) .Values.serviceAccount.name }}
{{- else }}
